          ...
          <div className="mx-auto max-w-7xl px-3 sm:px-4 md:px-6 py-6 sm:py-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
              ...
              <div className="grid grid-cols-[120px_minmax(0,2fr)_minmax(0,1.5fr)_minmax(0,1fr)_80px_120px] px-6 py-3 border-b border-slate-100 bg-slate-50/60 text-xs font-medium text-slate-500">
                ...
                <div className="text-center">Tarix</div>
              </div>
              ...
              <div>
                {expenses.map((expense) => (
                  ...
                  >
                    ...
                    {/* Product Name */}
                    <div>
                      <div className="text-[13px] font-semibold text-slate-800">{expense.name}</div>
                    </div>

                    {/* Category */}
                    <div className="text-[13px] text-slate-500">{expense.category}</div>

                    {/* Price */}
                    <div className="text-[13px] text-slate-800">{expense.price}</div>

                    {/* Quantity */}
                    <div className="text-[13px] text-slate-800 text-center">{expense.qty}</div>

                    {/* Date */}
                    <div className="text-[13px] text-slate-800 text-center">{expense.date}</div>
                  </div>
                ))}
              </div>
            </div>
